// [ARCHIVED - 2026-07] Legacy Backdrop styleguide page
// Superseded by: src/app/styleguide/backdrop/page.tsx (rebuilt 2026-07-21)
// Reason: did not follow the EDGE-DS full documentation standard (docs/DOCUMENTATION_STANDARDS.md
// section order). Covered only a single "Example Usage" demo with no Style Variants, no
// Interactivity states, and a partial Key Props table. Kept here for reference only; do not import.
//
// Original file: src/app/styleguide/backdrop/page.tsx
